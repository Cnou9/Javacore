...
//        System.out.println("ten :"+name.toUpperCase(Locale.ROOT));
//
//        System.out.println("moi ban nhap dia chi: ");
//        String address= scanner.nextLine();
//        System.out.println("dia chi: "+address.toUpperCase(Locale.ROOT));
//
...
//        System.out.printf("co %d hoc sinh trong lop", 2);
//        System.out.println("co "+ 2 +" hoc sinh tromg lop");
